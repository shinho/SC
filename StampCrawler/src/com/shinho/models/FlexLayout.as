package com.shinho.models {
	...
	public class FlexLayout extends Actor {
		...
		public function defineStage(header:Number, footer:Number, marginLeft:Number, marginRight:Number, minWidth:Number, minHeight:Number):void {
			_header = header;
			_footer = footer;
		...
		public function add(clipName:Object, xx:String, offset_x:Number, yy:String, offset_y:Number, ww:String, offset_w:Number, hh:String, offset_h:Number):void {
		...
		private function position(obj:Object, xx:Number, yy:Number, ww:Number, hh:Number):void {
			...
			TweenMax.to(obj, _delay, {x: tempX, y: tempY, width: tempW, height: tempH, delay: _wait, ease: Quint.easeOut});
		}
